...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.request = void 0;var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var BASE_URL = 'http://rap2api.taobao.org';
var token = _store.default.state.user.token || uni.getStorageSync('token');

var request = function request(options) {
  var url = (options.baseUrl ? options.baseUrl : BASE_URL + '/app/mock/297725') + options.url;
  return new Promise(function (resolve, reject) {
    uni.request({
      url: url,
...
var user = {
  ...
  mutationTypes.USERLOGIN, function (state, userInfo) {
  ...
  mutationTypes.USERLOGOUT, function (state) {
  ...
  mutationTypes.SET_TOKEN, function (state, token) {
    uni.setStorageSync('token', token);
  }), _mutations),

  actions: {
    checkLoginAction: function checkLoginAction(context, token) {
      commit(mutationTypes.SET_TOKEN, token);
    },
    userLoginAction: function userLoginAction(_ref,
  ...
  getters: {
    getNameById: function getNameById(state) {return function (id) {
        return state.userInfo.find(function (item) {
          if (item.userId === id) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.SET_TOKEN = exports.USERLOGOUT = exports.USERLOGIN = void 0;var USERLOGIN = 'userLogin'; // 登录
exports.USERLOGIN = USERLOGIN;var USERLOGOUT = 'userLogout'; //退出
exports.USERLOGOUT = USERLOGOUT;var SET_TOKEN = 'setToken';exports.SET_TOKEN = SET_TOKEN;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__3BF48C9" };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 257));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 258));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 259));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 286));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 287));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 288));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
